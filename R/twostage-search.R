...
#' the constraint `e1 >= r` (enabled via `non_binding`).
#'
...
#' @param non_binding Logical. If `TRUE`, restrict to designs with `e1 >= r`.
...
#'   `en_null`, `en_alt`, `is_non_binding`. Returns an empty `data.frame`
